...
def build_cmick_ensemble(input_width, input_height, in_channels):
    alpha11, alpha12, alpha13 = 1.0, 1.0, 1.0
    num_estimators = 10
...
def main():
    ...
    sqrt_pehe_cmnn_demo_only = fit_evaluate_cmnn_ensemble_demo_only(demo_input_dim, data_generators, data, lr=1e-3)
    ...
    sqrt_pehe_cmnn_image_demo = fit_evaluate_cmnn_ensemble_image_demo(input_width, input_height, in_channels, 
                                                                      demo_input_dim, data_generators, data, lr=5e-4)
