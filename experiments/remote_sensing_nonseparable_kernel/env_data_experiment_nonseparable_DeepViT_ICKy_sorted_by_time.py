...
def train_ick(data_generators, input_width, input_height, patch_size, latent_feature_dim, 
    ...
    model = AdditiveICK(
        components=[K_deepvit,K_per,K_mul], 
...
def main(args):
    ...
    spearmanr, pearsonr, rmse, mae = calculate_stats(
        y_test_pred, 
        y_test_true, 
        data_save_path='./Results/Nonseparable_DeepViT_ICKy_sorted_by_time.pkl', 
    )
    plot_pred_vs_true_vals(
        ...
        fig_save_path='./Figures/Nonseparable_DeepViT_ICKy_sorted_by_time.pdf', 
